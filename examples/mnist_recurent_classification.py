...
class RecurentLenet5(mod.ComposedModule):
    def define_inner_modules(self, name, activations, filter_shapes, bias_shapes, ksizes, pool_strides):
        ...
        self.layers["conv0"] = mod.TimeConvolutionalLayerModule("conv0",
            activations[0], filter_shapes[0], [1,1,1,1], bias_shapes[0])
        ...
        self.layers["conv1"] = mod.TimeConvolutionalLayerModule(name + "conv1",
            activations[1], filter_shapes[1], [1,1,1,1], bias_shapes[1])
